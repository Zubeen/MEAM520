...
blueDistFloating=[];blueAngleFloating=[];
        ...
        [obsnew,r,b,g]=get_obstcles(redDistBase0, redAngleBase0 ,redDistFloating, redAngleFloating,blueDistBase0 ,blueAngleBase0, blueDistFloating, blueAngleFloating,greenDistBase0, greenAngleBase0, greenDistFloating, greenAngleFloating,x,y,tr)
        'is at'
        x
        y
        tr*180/pi
...
blueDistFloating=[];blueAngleFloating=[];
        ...
        %     obsnew=[redXYBase0;redXYFloating;greenXYBase0;greenXYFloating;blueXYBase0;blueXYFloating];
        [obsnew,r,b,g]=get_obstcles(redDistBase0, redAngleBase0 ,redDistFloating, redAngleFloating,blueDistBase0 ,blueAngleBase0, blueDistFloating, blueAngleFloating,greenDistBase0, greenAngleBase0, greenDistFloating, greenAngleFloating,x,y,tl)
        'is at'
        x
        y
        tl*180/pi
...
blueDistFloating=[];blueAngleFloating=[];
            ...
            %     obsnew=[redXYBase0;redXYFloating;greenXYBase0;greenXYFloating;blueXYBase0;blueXYFloating];
            obsnew=[];
            [obsnew,r,b,g]=get_obstcles(redDistBase0, reI=imread(filename);
        [redStats greenStats blueStats]=getStats(I);
        if(~isempty(redStats))
            [redDistBase0 redAngleBase0 redDistFloating redAngleFloating]=getInf(redStats,1)
        end
        ...
        if(~isempty(g))
            ...
            plot(g(:,1),g(:,2),'go');
            hold on;
        enddAngleBase0 ,redDistFloating, redAngleFloating,blueDistBase0 ,blueAngleBase0, blueDistFloating, blueAngleFloating,greenDistBase0, greenAngleBase0, greenDistFloating, greenAngleFloating,x,y,theta)
