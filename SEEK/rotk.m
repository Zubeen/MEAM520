...
clear pointcentrsx;clear pointcentrsy;
...
pointcentrs1=[pointcentrsx(:) pointcentrsy(:)];
...
pointcentrs2=[pointcentrsx(:) pointcentrsy(:)];



pointctrs=[pointcentrs;pointcentrs1;pointcentrs2];
pointcentrs=(pointctrs);
pointcentrs=unique(pointcentrs,'rows');
xpts=[x1;x2;x3];
ypts=[y1;y2;y3];
xpts=unique(x);
ypts=unique(y);
...
% %         tr=0;
%         set_velocities(Robot,0,0);
%         obstcles=analyzeThat(filename,x,y,0,obstcles);    
%         
%         set_velocities(Robot,-v_l1,v_r1)
%         pause(1.5)
%         set_velocities(Robot,0,0)
% %         tl=pi/2;
%         obstcles=analyzeThat(filename,x,y,pi/2,obstcles);
%         
%         
%         set_velocities(Robot,-v_l1,v_r1)
%         pause(1.5)
%         set_velocities(Robot,0,0)
% %         t0=pi/4;
%         obstcles=analyzeThat(filename,x,y,pi/4,obstcles);
%         
%         set_velocities(Robot,v_l1,-v_r1)
%         pause(1.5)
%         set_velocities(Robot,0,0);
...
%         set_velocities(Robot,0,0);
    ...
    obstcles=analyzeThat(filename,x,y,t,obstcles);
    if(count==1)
